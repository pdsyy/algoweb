...
import dep_icon1 from "../images/dep_icon1.svg";
import dep_icon2 from "../images/dep_icon2.svg";
import dep_icon3 from "../images/dep_icon1.svg";
import dollar_circle from "../pages/Terra/images/dollar_circle.svg";
import gradient_icon from "../images/gradient_line.svg";
import orange_line_icon from "../images/orange_line.svg";
import calendar_prop_icon from "../images/calendar_prop_icon.svg";
                ...
                <motion.div className="calculate_block" {...fadeNumeric} custom={1}>
                    ...
                    <div className="input_block">
                        <div className="input_icon">
                            <img src={dollar_circle} alt="icon"/>
                        </div>
                        <input
                            type="text"
                            inputMode="numeric"
                                ...
                                <div className="legend_section">
                                    ...
                                    <div className="legend_block">
                                        <div className="legend_icon">
                                            <img src={gradient_icon} alt=""/>
                                        </div>
                                        {t.prop.calculator.graph.legend.balance}
                                    </div>
                                    <div className="legend_block">
                                        <div className="legend_icon">
                                            <img src={orange_line_icon} alt=""/>
                                        </div>
